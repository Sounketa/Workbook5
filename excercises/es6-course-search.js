...
let PROG500Course = courses.find((course) => course.CourseId == "PROG500");
console.log(PROG500Course.Title);

// What are the titles of the courses that cost $50 or less?
let courseCost = courses.filter((course) => course.Fee <= 50).map((course) => course.Title)
